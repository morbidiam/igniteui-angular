...
import { ColumnType, GridServiceType, GridType, IgxColumn, IgxGridHeaderTemplateContext, IgxGridRowTemplateContext, IGX_GRID_SERVICE_BASE, ISizeInfo, RowType } from './common/grid.interface';
